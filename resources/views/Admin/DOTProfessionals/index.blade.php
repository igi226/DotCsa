                        ...
                        <tbody>
                          @foreach ($dotProfessionals as $dotProfessional)
                            ...
                            <tr>
                                    ...
                                    <div class="product">
                                        <div class="image">
                                          @if (!empty($dotProfessional->profile_doc))
                                            <a href="{{ asset('storage/DotProfessionalContent/'.$dotProfessional->profile_doc) }}" rel="noopener noreferrer" class="download-icon text-success"><i class="lni lni-download"></i></a>
                                          @else
                                ...
                                <td>
                                  <p class="text-sm">{{ $dotProfessional->address }}<br>{{ $dotProfessional->zipcode }} </p>
