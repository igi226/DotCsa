            ...
            <ul>
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}">
                        ...
                        <span
                            class="text {{ Route::currentRouteName() == 'admin.dashboard' ? 'active' : '' }}">Dashboard</span>
                    </a>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.gallery') }}">
                        ...
                        <span class="text {{ Route::currentRouteName() == 'admin.gallery' ? 'active' : '' }}">Gallery
                            Management</span>
                    </a>
                ...
                <li class="nav-item">
                    <a href="{{ route('site.info') }}">
                        ...
                        <span class="text {{ Route::currentRouteName() == 'site.info' ? 'active' : '' }}">Site
                            Setting</span>
                    </a>
